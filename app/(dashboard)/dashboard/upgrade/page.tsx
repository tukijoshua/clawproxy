    ...
    <div className="flex items-start justify-center min-h-[calc(100vh-90px)] py-[32px] px-[16px]">
      ...
      >
        ...
        <div className="text-center mb-[32px]">
          ...
          <p
            className="mt-[10px] text-[15px] leading-[1.5] text-[#5C5C58]"
          ...
          <div className="flex items-center gap-[16px]">
            <span
              ...
              style={{
                ...
                color: planKey === 'team' ? '#7C3AED' : '#157A3E',
            ...
            <div>
              <p
                ...
                style={{
                  fontFamily: 'Aeonik Pro, sans-serif',
                  color: planKey === 'team' ? '#5B21B6' : '#0D5428',
                }}
              >
                {plan.roiDescription}
              </p>
              <p
                className="text-[12px] leading-[1.4] mt-[2px]"
                style={{
                  fontFamily: 'Aeonik Pro, sans-serif',
                  color: planKey === 'team' ? '#5B21B6' : '#0D5428',
                  opacity: 0.8,
        ...
        <div
          className="rounded-[7px] overflow-hidden mb-[32px]"
          style={{ border: '1px solid #E4E3DE' }}
        >
          {/* Header */}
          <div
            className="grid grid-cols-[1fr_100px_120px] sm:grid-cols-[1fr_120px_140px] h-[44px] items-center"
            style={{ backgroundColor: '#F0EFEB' }}
          >
            <span
              className="pl-[20px] text-[12px] text-[#5C5C58]"
              style={{ fontFamily: 'Aeonik Pro, sans-serif', fontWeight: 500 }}
            >
              Feature
            </span>
            <span
              className="text-center text-[12px] text-[#5C5C58]"
              style={{ fontFamily: 'Aeonik Pro, sans-serif', fontWeight: 500 }}
            >
              {plan.compareFrom}
            </span>
            <div
              ...
              style={{
                backgroundColor: planKey === 'team' ? 'rgba(124,58,237,0.08)' : 'rgba(220,238,227,0.3)',
              }}
            >
              <span
                className="text-[12px]"
          ...
          {plan.features.map((feature, i) => (
            <div
              ...
              style={{
                ...
                backgroundColor: i % 2 === 1 ? '#FAFAF8' : 'white',
              }}
            >
              <span
                className="pl-[20px] text-[13px] text-[#141413]"
                style={{ fontFamily: 'Aeonik Pro, sans-serif' }}
              >
                {feature.name}
              </span>
              <span
                ...
                style={{
                  fontFamily: 'Aeonik Pro, sans-serif',
                  color: feature.from === '✓' ? '#157A3E' : feature.from === '✕' ? '#9C9C96' : '#141413',
                }}
              >
                {feature.from}
              </span>
              <div
                ...
                style={{
                  backgroundColor: planKey === 'team' ? 'rgba(124,58,237,0.04)' : 'rgba(220,238,227,0.15)',
                }}
              >
                <span
                  className="text-[13px]"
